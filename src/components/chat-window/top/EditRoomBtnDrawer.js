    ...
    <div>
      ...
      <Drawer full={isMobile} show={isOpen} onHide={close} placement="right">
        ...
        <Drawer.Body>
            ...
            <EditableInput componentClass="textarea" rows={5} initialValue={description} onSave={onDescriptionSave} emptyMsg="Description can not be empty" wrapperClassName="mt-3" />
        </Drawer.Body>
        <Drawer.Footer>
